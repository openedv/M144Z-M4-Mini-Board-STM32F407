...
/**
 * @brief   SPI2 speed setting function
 * @param   speed: SPI2 clock division factor
 * @retval  None
 */
void spi1_set_speed(uint32_t speed)
{
    __HAL_SPI_DISABLE(&hspi1);                      /* Turn off SPI */
    hspi1.Instance->CR1 &= ~SPI_CR1_BR_Msk;         /* Bits 3-5 are reset to set the baud rate */
    hspi1.Instance->CR1 |= speed;                   /* Set SPI speed */
