...
/**
* @brief 	Writes the specified word data to the specified address
* @param 	addr: specifies the address to write data to
* @param 	buf: start address for storing written data
* @param 	length: Specifies the length of the data to be written, in words
* @retval 	None
*/
void stmflash_write(uint32_t addr, uint32_t *buf, uint16_t length)
{
    ...
    /* Check the validity of the write address range */
