 ...
 * 1, it's connected.
 */
volatile uint8_t g_device_state = 0;    /* No connection by default */
...
void HAL_PCD_MspInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  {
      /* USB OTG HS This routine is not used, so do not do processing */
  }
}
...
#endif /* USE_HAL_PCD_REGISTER_CALLBACKS */
{
  g_device_state = 1; /* If this function can be executed, the USB connection is successful */
