...
/* ADC1 init function */
void MX_ADC1_Init(uint32_t memory_base)
{
...
void adc_nch_dma_enable(uint32_t length)
{
    ...
    HAL_ADC_Start_DMA(&hadc1, (uint32_t *)g_adc_nch_dma_memory_base, length);
}

/**
 * @brief   HAL library ADC conversion complete callback function
