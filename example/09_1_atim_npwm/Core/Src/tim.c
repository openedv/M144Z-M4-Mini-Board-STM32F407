...
void TIM8_UP_TIM13_IRQHandler()
{
    ...
    {
        /* Maximum of 256 PWM outputs each time (only [7:0] of TIMx_RCR is valid) */
        if (g_npwm_remain > 256)
        {
            g_npwm_remain -= 256;
            npwm = 256;
        }
        else if ((g_npwm_remain % 256) != 0)
        {
        ...
        if (npwm != 0)
        {
            /* Use the advanced timer's repetition counter to output PWM */
        	TIM8->RCR = npwm - 1;
