 ...
 * PC2LCD2002 module mode setting: negative code + column by column + forward + C51 format
 * Total: 4 character sets (12*12, 16*16, 24*24, and 32*32), you are free to add additional character sets.
 * The number of bytes per character is (size/8+((size%8)? 1:0))*(size/2), where size: is the dot matrix size when the font was generated (12/16/24/32...)
 */
...
/* 24*24 ASCII character set dot matrix */
...
/* 32*32 ASCII character set dot matrix */
