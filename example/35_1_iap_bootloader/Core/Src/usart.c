...
uint8_t g_rx_buffer[RXBUFFERSIZE];  /* the serial port used by the HAL library receives buffers */
uint32_t g_usart_rx_cnt = 0;        /* Number of bytes received */
...
{
    if (huart->Instance == USART1)       /* If it is serial port 1 */
    {
