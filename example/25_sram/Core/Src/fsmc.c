...
void MX_FSMC_Init(void)
{
  ...
  */
  ...
  /* hsram2.Init */
  hsram2.Init.NSBank = (SRAM_FSMC_NEX == 1) ? FSMC_NORSRAM_BANK1 :
...
/**
 * @brief       Write specified length of data to a specified address in SRAM
 * @param       pbuf    : Pointer to the data buffer
 * @param       addr    : Starting address to write data (up to 32 bits)
 * @param       datalen : Number of bytes to write (up to 32 bits)
 * @retval      None
 */
