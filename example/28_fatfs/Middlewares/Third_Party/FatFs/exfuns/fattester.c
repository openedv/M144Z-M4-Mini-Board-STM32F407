...
void mf_gets(uint16_t size)
{
    ...
    {
        printf("\r\nThe String Read is: %s\r\n", rbuf);
    }
}

/**
 * @brief       Writes a character to a file (requires FF_USE_STRFUNC >= 1)
...
/**
 * @brief       Writes a string to a file (requires FF_USE_STRFUNC >= 1)
